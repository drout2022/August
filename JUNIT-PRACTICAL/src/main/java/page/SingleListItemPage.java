...
//data for the list item
	...
	@FindBy(how = How.NAME,using="todo[16]") WebElement FIRST_LIST_ITEM_BOX_ELEMENT;
	...
	public void addListItem() {
		LIST_ITEM_ELEMENT.sendKeys(item);
	...
	public void validateSingleItemRemoved() {
		Assert.assertFalse(driver.getPageSource().contains(item));
